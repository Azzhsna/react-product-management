  ...
  return (
    <div className="product-detail-page">
      ...
      <div className="detail-content">
        <div className="detail-content-accent" aria-hidden="true"></div>
          ...
          {loading || !product ? (
            <>
              ...
              <div className="product-info">
                ...
                <div
                  className="skeleton"
                  style={{ width: "80%", height: "40px", marginBottom: "16px" }}
                ></div>
                <div
                  className="skeleton"
                  style={{ width: "60%", height: "24px", marginBottom: "24px" }}
                ></div>

                <div
                  className="price-section"
                  style={{ border: "none", padding: "0 0 24px 0" }}
                >
                  <div
                    className="skeleton"
            ...
            <>
              <div className="product-gallery">
                ...
                <div className="image-thumbnails">
                  <div
                    className={`thumb ${
                      activeImage === product.thumbnail ? "active" : ""
                    }`}
